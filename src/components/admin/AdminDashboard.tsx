...
import { Users, Settings, DollarSign, BarChart2, HelpCircle, Globe, Shield, Zap, Layout, FileText } from 'lucide-react';
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-indigo-700 text-white p-4 overflow-y-auto">
        <Link to="/" className="block mb-8">
          <h1 className="text-2xl font-bold">BeatBiz Admin</h1>
        </Link>
        <AccordionMenu menuItems={menuItems} basePath="/admin" />
      </aside>
